...
$sql = "SELECT idUsuario, nomUsuario, nomPersonaUsuario, tipoUsuario, contraseña FROM usuario WHERE nomUsuario = '$usuario'";
...
if ($registro != FALSE) { //Si se encontro el usuario
    if ($passwordMD5 == $registro['contraseña']) { // Si las contraseñas coinciden
        ...
        $nombreUsuario = array($registro['nomUsuario'], $registro['nomPersonaUsuario']);
